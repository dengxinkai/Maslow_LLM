def update_sale_assistant(assistant_id, assist_name, task, role, background, user, relationship_history, occasion, role_response, history):
    ...
    return assistant
def get_sale_help(thread_id, assistant_id,role,role_response,history,relationship_history):
